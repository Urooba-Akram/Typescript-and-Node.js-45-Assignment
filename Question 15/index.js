...
//can’t make the dinner, so you need to send 
...
var oldGuestList = ["Asad", "Iqra", "Faiza"];
var cannotAttend = "Faiza";
console.log(cannotAttend + " ", "can not attend the dinner.");
var newGuest = "Afsheen";
oldGuestList[oldGuestList.indexOf(cannotAttend)] = newGuest;
//console.log(oldGuestList);
oldGuestList.map(function (items) {
    return console.log("Hi ".concat(items, ", I would like to invite you to dinner."));
});
